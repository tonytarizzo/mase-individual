...
# Define the path where the preprocessed data will be stored
...
# Load and preprocess a small sample dataset
sample_list = list(load_dataset(dataset_name, split="validation").take(50))
